...
// Define UUIDs:
static BLEUUID serviceUUID("bdf0e32b-970d-41a0-99ac-4a997939c875");
...
static void notifyCallback(BLERemoteCharacteristic* pBLERemoteCharacteristic,
  ...
  if(pBLERemoteCharacteristic->getUUID().toString() == charUUID_1.toString()) {
    ...
    // print to Serial
    Serial.print("Characteristic 1 (Notify) from server (Count): ");
...
void loop() {
  ...
  // If we are connected to a pemer BLE Server, update the characteristic each time we are reached
